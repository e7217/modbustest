...
function control_led(comm_num){
    ...
    if(comm_num == 'name'){
        var cmd = 'sudo python ./modbustest/rr_deviceName.py'
        exec(cmd, function callback(error, stdout, stderr) {
            console.log(stdout);
        });
    }
    else  if(comm_num == 'ps'){
        var cmd = 'sudo python ./modbustest/rr_powerStatus.py'
        exec(cmd, function callback(error, stdout, stderr) {
            console.log(stdout);
        });
    }
    else  if(comm_num == 'rs'){
        var cmd = 'sudo python ./modbustest/rr_runStatus.py'
        exec(cmd, function callback(error, stdout, stderr) {
            console.log(stdout);
        });
    }
    else  if(comm_num == 'as'){
        var cmd = 'sudo python ./modbustest/rr_alarmStatus.py'
        exec(cmd, function callback(error, stdout, stderr) {
            console.log(stdout);
        });
    }
    else  if(comm_num == 'ts'){
        var cmd = 'sudo python ./modbustest/rr_tempStatus.py'
        exec(cmd, function callback(error, stdout, stderr) {
            console.log(stdout);
        });
    }
    else  if(comm_num == 'pon'){
        var cmd = 'sudo python ./modbustest/wr_powerOn.py'
        exec(cmd, function callback(error, stdout, stderr) {
            console.log(stdout);
        });
    }
    else  if(comm_num == 'poff'){
        var cmd = 'sudo python ./modbustest/wr_powerOff.py'
        exec(cmd, function callback(error, stdout, stderr) {
            console.log(stdout);
        });
    }
    else  if(comm_num == 'ron'){
        var cmd = 'sudo python ./modbustest/wr_runOn.py'
        exec(cmd, function callback(error, stdout, stderr) {
            console.log(stdout);
        });
    }
    else  if(comm_num == 'roff'){
        var cmd = 'sudo python ./modbustest/wr_runOff.py'
        exec(cmd, function callback(error, stdout, stderr) {
            console.log(stdout);
        });
    }
